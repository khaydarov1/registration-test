...
class QuesionIndexViewTests(TestCase):
    ...
    def test_future_question_and_past_question(self):
        ...
        reponse = self.client.get(reverse('users:index'))
        self.assertQuerysetEqual(reponse.contex['latest_question_list'], [question], )

    def test_two_past_questions(self):
        question1 = create_question(question_text="Past question 1.", days=-30)
        question2 = create_question(question_text="Past question 2.", days=-5)
        response = self.client.get(reverse('users:index'))
        self.assertQuerysetEqual(response.cotext['latest_question_list'], [question2, question1], )
